...
const fix = (id, other, who) => {
  ...
  note(p, `${who} took out the licence at Olympia on 8 Jan 1942, a month after Pearl Harbor, and married the next day at Pasco, where Beryl's parents lived at the Episcopal Church of Our Saviour, Beryl being 22 and the register naming her parents Raymond and Dradie Simons (county marriage records; Episcopal Diocese of Spokane church records, vol. 2).`);
  add(p.sources, SRC);
  save(p);
};
