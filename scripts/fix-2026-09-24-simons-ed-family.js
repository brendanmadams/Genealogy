#!/usr/bin/env node
/**
 * 2026-09-24, Ed Simons's wife Kim and son John (Brendan Adams). Both living:
 * names and relationships only. Kim is not recorded as the mother of Ed's
 * children, since that was not stated. Re-runnable.
 */
'use strict';
...
person('simons_kim', 'Kim Simons', 'F', p => { p.relationships.spouse = 'simons_ed'; });
person('simons_john', 'John Simons', 'M', p => { p.relationships.father = 'simons_ed'; });
