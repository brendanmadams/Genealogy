#!/usr/bin/env node
/**
 * Apply the facts from "John Howard Adams - A Memoir" approved by Brendan
 * Adams on 2026-09-23 (data/imports/john-memoir-2026-09-23.json): a gap check
...
const IMP = JSON.parse(fs.readFileSync(path.resolve(__dirname, '..', 'data', 'imports', 'john-memoir-2026-09-23.json'), 'utf8'));
...
const cite = f => ` [John Howard Adams, A Memoir, text line ${f.lines.join(', ')}]`;
